...
const DashboardFilm = () => {
    ...
    return (
        <Container className="pb-5">
            <h1 className=" p-2" id="Trending">TRENDING MOVIES</h1>
            <Row>
                {Films.map((result, index) => {
                    return (
                        <Col md={4} className="movieWrapper" key={index}>
                            <Card className="movieImage" style={{ cursor: 'pointer' }} onClick={() => handleFilm(`${result.id}`)}>
                                <Image
                                ...
                                <div className="bg-dark">
                                    <div className="p-2 m-1 text-white">
                                        <Card.Title className="text-center" style={{ textTransform: 'uppercase'}}>
                                            {result.judulFilm}
                                        </Card.Title>
